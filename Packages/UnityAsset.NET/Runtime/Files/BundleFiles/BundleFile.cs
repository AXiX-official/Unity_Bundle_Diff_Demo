...
using System.Linq;
using System.Text;
using UnityAsset.NET.Compression;
...
namespace UnityAsset.NET.Files.BundleFiles
{
    public class BundleFile : IFile
    {
        ...
        public static BlocksAndDirectoryInfo ParseDataInfo(IReader reader, Header header)
        {
            ...
            Compression.Compression.DecompressToBytes(blocksInfoBytes, blocksInfoUncompressedData.AsWritableSpan, compressionType);
            ...
            CompressionType dataPacker = CompressionType.Lz4HC, string? unityCnKey = null)
        {
            ...
            var compressedDataInfoStream = Compression.Compression.CompressToStream(dataInfoStream.ToArray(), infoPacker);
